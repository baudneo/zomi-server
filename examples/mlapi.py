#!/opt/zomi/server/venv/bin/python3
...
from zomi_server.app import create_logs, MLAPI
...
def _parse_cli():
    ...
    parser = ArgumentParser(description="Start the ML API server or manage the user DB")
...
if __name__ == "__main__":
    ...
    if user_mode:
        ...
        from zomi_server.Models.config import parse_client_config_file
        from zomi_server.auth import UserDB, ZoMiUser
        ...
        if user_mode == "--create":
            ...
            user = db.authenticate_user(
                username, password, cfg=cfg, bypass=True, ip="CLI=N/A"
            )
